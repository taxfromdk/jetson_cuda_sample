 ...
 #define GST_cuda_sample(obj) \
   (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_CUDA_SAMPLE,GstCudaSample))
 #define GST_cuda_sample_CLASS(klass) \
   (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_CUDA_SAMPLE,GstCudaSampleClass))
 #define GST_IS_cuda_sample(obj) \
   (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_CUDA_SAMPLE))
 #define GST_IS_cuda_sample_CLASS(klass) \
   (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_CUDA_SAMPLE))
